...
var _react = _interopRequireDefault(__webpack_require__(399));
...
var React = _interopRequireWildcard(__webpack_require__(399));
...
var _react = __webpack_require__(399);
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 616)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 704))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-mdx',plugin:__webpack_require__(839),options:{"plugins":[],"extensions":[".mdx"],"defaultLayouts":{},"gatsbyRemarkPlugins":[],"lessBabel":false,"remarkPlugins":[],"rehypePlugins":[],"mediaTypes":["text/markdown","text/x-markdown"],"root":"C:\\Users\\mafud\\Documents\\git\\mafudge\\static-website-michaelfudge.com\\site","commonmark":false}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
// EXTERNAL MODULE: external "C:\\Users\\mafud\\Documents\\git\\mafudge\\static-website-michaelfudge.com\\site\\node_modules\\react\\index.js"
var external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_ = __webpack_require__(399);
var external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_);
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement((external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
var MDXContext = /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createContext({});
var withMDXComponents = function withMDXComponents(Component) {
  return function (props) {
    var allComponents = useMDXComponents(props.components);
    return /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(Component, _extends({}, props, {
      components: allComponents
    }));
  };
};
var useMDXComponents = function useMDXComponents(components) {
  var contextComponents = external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().useContext(MDXContext);
...
var MDXProvider = function MDXProvider(props) {
  var allComponents = useMDXComponents(props.components);
  return /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(MDXContext.Provider, {
    value: allComponents
  }, props.children);
};
...
var DEFAULTS = {
  ...
  wrapper: function wrapper(_ref) {
    ...
    return /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement((external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).Fragment, {}, children);
  }
};
var MDXCreateElement = /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().forwardRef(function (props, ref) {
  ...
  if (propComponents) {
    return /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(Component, _objectSpread2(_objectSpread2({
      ref: ref
    }, etc), {}, {
  ...
  return /*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(Component, _objectSpread2({
    ref: ref
  }, etc));
});
...
const GatsbyMDXScopeContext=/*#__PURE__*/(0,external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_.createContext)({});const useMDXScope=scope=>{const contextScope=useContext(GatsbyMDXScopeContext);return scope||contextScope;};const MDXScopeProvider=({__mdxScope,children})=>/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(GatsbyMDXScopeContext.Provider,{value:__mdxScope},children);
// EXTERNAL MODULE: ./node_modules/gatsby-plugin-mdx/loaders/mdx-components.js
var mdx_components = __webpack_require__(86);
 ...
 * Submit a PR
 */const componentsAndGuards={};const componentFromGuards=arr=>function GatsbyMDXComponentFinder(props){const{Component}=arr.find(({guard})=>guard?guard(props):true);return/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(Component,props);};mdx_components.plugins.forEach(({guards={},components})=>{Object.entries(components).forEach(([componentName,Component])=>{if(componentsAndGuards[componentName]){componentsAndGuards.push({guard:guards[componentName],Component});}else{componentsAndGuards[componentName]=[{guard:guards[componentName],Component}];}});});const components=Object.entries(componentsAndGuards).map(([name,arr])=>{return{[name]:componentFromGuards(arr.concat({guard:undefined,Component:name}))};}).reduce((acc,obj)=>{return _objectSpread(_objectSpread({},acc),obj);},{});// merge any components in wrapRootElement above this wrapRoot
const MDXConsumer=withMDXComponents(({components:componentsFromContext,children})=>/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(MDXScopeProvider,{__mdxScope:mdx_scopes},/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(MDXProvider,{components:_objectSpread(_objectSpread({},componentsFromContext),components)},children)));const WrapRootElement=({element})=>/*#__PURE__*/external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(MDXConsumer,null,element);/* harmony default export */ const wrap_root_element = (WrapRootElement);
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  var children = _ref.children;
  return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
...
}((external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).Component);
    ...
    function (baseContext) {
      return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
        ...
        external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_C_Users_mafud_Documents_git_mafudge_static_website_michaelfudge_com_site_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
"use strict";
module.exports = require("C:\\Users\\mafud\\Documents\\git\\mafudge\\static-website-michaelfudge.com\\site\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\mafud\\Documents\\git\\mafudge\\static-website-michaelfudge.com\\site\\node_modules\\react-dom\\server.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-0d62215cc28ba6940754.js"],"app":["/app-dc2ebd0dbb475499597b.js"],"component---src-pages-404-js":["/component---src-pages-404-js-225f36489e742c74928c.js"],"component---src-pages-index-js":["/component---src-pages-index-js-dc1730dad36fb344236f.js"]}');
...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly){symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;});}keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=arguments[i]!=null?arguments[i]:{};if(i%2){ownKeys(Object(source),true).forEach(function(key){(0,_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)(target,key,source[key]);});}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source));}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}}return target;}const React=__webpack_require__(399);const path=__webpack_require__(423);const{renderToString,renderToStaticMarkup,pipeToNodeWritable}=__webpack_require__(637);const{ServerLocation,Router,isRedirect}=__webpack_require__(631);const merge=__webpack_require__(996);const{StaticQueryContext}=__webpack_require__(31);const fs=__webpack_require__(966);const{WritableAsPromise}=__webpack_require__(709);const{RouteAnnouncerProps}=__webpack_require__(394);const{apiRunner,apiRunnerAsync}=__webpack_require__(874);const asyncRequires=__webpack_require__(999);const{version:gatsbyVersion}=__webpack_require__(741);const{grabMatchParams}=__webpack_require__(438);const chunkMapping=__webpack_require__(804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
